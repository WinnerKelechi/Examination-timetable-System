...
?>
        ...
        <table style="width:100%;float:left">
            ...
            <?php $query1=mysqli_query($con,"select * from exam_sched natural join member natural join time where exam_sched.cys='$class'and settings_id='$sid' or exam_sched.cys1='$class' order by day,time_start")or die(mysqli_error($con));
