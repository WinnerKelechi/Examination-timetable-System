                                            ...
                                            <div class="col-md-12">
                                                <form method="post" action="department_save.php">
                                                    <div class="form-group">
                                                        <label for="date">Add Department Short Code</label><br>
                                                        <input type="text" class="form-control" name="code" placeholder="Department Short Code" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form method="post" action="department_update.php">
                                                    <div class="form-group">
                                                        <label for="date">Update <br> Department Short Code</label><br>
                                                        <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" readonly>
                                                        <input type="text" class="form-control" id="class" name="code" value="<?php echo $_REQUEST['code'];?>" placeholder="Department Short Code" required>
                                                    </div><!-- /.form group -->
                                                    <div class="form-group">
                                                        <label for="date">Department Name</label><br>
