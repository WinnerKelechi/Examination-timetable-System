    ...
    <div class="wrapper">
                            ...
                            <div class="box box-warning">
                                <form method="post" id="reg-form">
                                    <div class="box-body">
                                        ...
                                        <span style="font-size:18px;font-weight:bolder" class="pull-right">Display Exam Schedule &nbsp;</span>
                                        <br><br>
		...
		?>
                                                    <tr style="text-align:center">
                                                        ...
                                                        <td><input type="checkbox" name="forth[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="height:auto">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">View Lecturer's Exam Schedule</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="faculty_exam.php" target="_blank">

                        <div class="form-group">
                            <label class="control-label col-lg-3" for="name">Lecturer</label>
                            <div class="col-lg-9">
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="height:auto">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">View Class Exam Schedule</h4>
                </div>
                <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="height:auto">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">View Exam Schedule for Venue</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="room_exam.php" target="_blank">

                        <div class="form-group">
                            <label class="control-label col-lg-3" for="name">Venue</label>
                            <div class="col-lg-9">
