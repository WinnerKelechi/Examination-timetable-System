    ...
    <div class="wrapper">
		...
		?>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" name="f[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;" <?php if(($id==$time_id) and ($day=='first' )) echo "checked" ; ?>>
                                                        </td>
                                                        <td><input type="checkbox" name="s[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;" <?php if(($id==$time_id) and ($day=='second' )) echo "checked" ; ?>></td>
                                                        <td><input type="checkbox" name="t[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;" <?php if(($id==$time_id) and ($day=='third' )) echo "checked" ; ?>></td>
				...
				?>
                                <div class="box-body">
								  ...
								  ?>
                                                        <option value="<?php echo $row2['member_id'];?>">
                                                            <?php echo $row2['member_last'].", ".$row2['member_first'];?>
                                                        </option>
                                                        <?php }
