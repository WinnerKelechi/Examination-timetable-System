                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="date">Add Venue</label><br>
                                                    <input type="text" class="form-control" name="room" placeholder="Venue" required>

                                                </div>
                                                <div class="form-group">
                                                    <label for="date">Add Venue Capacity</label><br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form method="post" action="room_update.php">
                                                    <div class="form-group">
                                                        <label for="date">Update Venue</label><br>
                                                        <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" placeholder="Venue ID" readonly>
                                                        <input type="text" class="form-control" id="class" name="room" value="<?php echo $_REQUEST['room'];?>" placeholder="Venue" required>
                                                    </div><!-- /.form group -->
                                            </div>
                                        </div>
